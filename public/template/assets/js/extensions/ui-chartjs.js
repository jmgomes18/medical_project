...
(() => {
    var e = {
            7432: function(e, t, a) {
                e.exports = function(e) {
                        ...
                        r = t((function(e) {
                            ...
                            r.rgb.hsl = function(e) {
                                ...
                                var t, a, n, r, i, s, o, d = e[0] / 360,
                                    ...
                                    u = e[2] / 100,
                                    _ = l + u;
                                switch (_ > 1 && (l /= _, u /= _), n = 6 * d - (t = Math.floor(6 * d)), 0 != (1 & t) && (n = 1 - n), r = l + n * ((a = 1 - u) - l), t) {
                                    default:
                                    case 6:
                                    case 0:
                                        i = a, s = r, o = l;
                    ...
                    function p(e) {
                        if (e) {
                            ...
                            if (a) {
                                ...
                                return [j(parseInt(a[1]), 0, 360), j(parseFloat(a[2]), 0, 100), j(parseFloat(a[3]), 0, 100), j(isNaN(n) ? 1 : n, 0, 1)]
                            }
                        }
                    }
                    ...
                    function v(e, t) {
                        return t = void 0 !== t && 3 === e.length ? t : e[3], "#" + P(e[0]) + P(e[1]) + P(e[2]) + (t >= 0 && t < 1 ? P(Math.round(255 * t)) : "")
                    }

                    function b(e, t) {
                        return t < 1 || e[3] && e[3] < 1 ? k(e, t) : "rgb(" + e[0] + ", " + e[1] + ", " + e[2] + ")"
                    }
                    ...
                    function x(e, t) {
                        return t < 1 || e[3] && e[3] < 1 ? T(e, t) : "hsl(" + e[0] + ", " + e[1] + "%, " + e[2] + "%)"
                    }
                            ...
                            roundedRect: function(e, t, a, n, r, i) {
                                if (i) {
                                    var s = Math.min(i, r / 2, n / 2),
                                        ...
                                        l = t + n - s,
                                        u = a + r - s;
                                    e.moveTo(t, d), o < l && d < u ? (e.arc(o, d, s, -B, -U), e.arc(l, d, s, -U, 0), e.arc(l, u, s, 0, U), e.arc(o, u, s, U, B)) : o < l ? (e.moveTo(o, a), e.arc(l, d, s, -U, U), e.arc(o, d, s, U, B + U)) : d < u ? (e.arc(o, d, s, -B, 0), e.arc(o, u, s, 0, B)) : e.arc(o, d, s, -B, B), e.closePath(), e.moveTo(t, a)
                                } else e.rect(t, a, n, r)
                            },
                            drawPoint: function(e, t, a, n, r, i) {
                                var s, o, d, l, u, _ = (i || 0) * V;
                                ...
                                if (!(isNaN(a) || a <= 0)) {
                                    switch (e.beginPath(), t) {
                                        default:
                                            ...
                                            break;
                                        case "triangle":
                                            e.moveTo(n + Math.sin(_) * a, r - Math.cos(_) * a), _ += q, e.lineTo(n + Math.sin(_) * a, r - Math.cos(_) * a), _ += q, e.lineTo(n + Math.sin(_) * a, r - Math.cos(_) * a), e.closePath();
                                            break;
                                        case "rectRounded":
                                            l = a - (u = .516 * a), o = Math.cos(_ + G) * l, d = Math.sin(_ + G) * l, e.arc(n - o, r - d, u, _ - B, _ - U), e.arc(n + d, r - o, u, _ - U, _), e.arc(n + o, r + d, u, _, _ + U), e.arc(n - d, r + o, u, _ + U, _ + B), e.closePath();
                                            break;
                                        case "rect":
                                            if (!i) {
                                            ...
                                            _ += G;
                                        case "rectRot":
                                            o = Math.cos(_) * a, d = Math.sin(_) * a, e.moveTo(n - o, r - d), e.lineTo(n + d, r - o), e.lineTo(n + o, r + d), e.lineTo(n - d, r + o), e.closePath();
                                            break;
                                        case "crossRot":
                                            _ += G;
                                        case "cross":
                                            o = Math.cos(_) * a, d = Math.sin(_) * a, e.moveTo(n - o, r - d), e.lineTo(n + o, r + d), e.moveTo(n + d, r - o), e.lineTo(n - d, r + o);
                                            break;
                                        case "star":
                                            o = Math.cos(_) * a, d = Math.sin(_) * a, e.moveTo(n - o, r - d), e.lineTo(n + o, r + d), e.moveTo(n + d, r - o), e.lineTo(n - d, r + o), _ += G, o = Math.cos(_) * a, d = Math.sin(_) * a, e.moveTo(n - o, r - d), e.lineTo(n + o, r + d), e.moveTo(n + d, r - o), e.lineTo(n - d, r + o);
                                            break;
                                        case "line":
                                            o = Math.cos(_) * a, d = Math.sin(_) * a, e.moveTo(n - o, r - d), e.lineTo(n + o, r + d);
                                            break;
                                        case "dash":
                                            e.moveTo(n, r), e.lineTo(n + Math.cos(_) * a, r + Math.sin(_) * a)
                                    }
                                    e.fill(), e.stroke()
                                }
                            },
                    ...
                    function we(e, t, a, n) {
                        var r, i = a.endAngle;
                        for (n && (a.endAngle = a.startAngle + ke, De(e, a), a.endAngle = i, a.endAngle === a.startAngle && a.fullCircles && (a.endAngle += ke, a.fullCircles--)), e.beginPath(), e.arc(a.x, a.y, a.innerRadius, a.startAngle + ke, a.startAngle, !0), r = 0; r < a.fullCircles; ++r) e.stroke();
                        for (e.beginPath(), e.arc(a.x, a.y, t.outerRadius, a.startAngle, a.startAngle + ke), r = 0; r < a.fullCircles; ++r) e.stroke()
                    }
                    ...
                    var Te = he.extend({
                            ...
                            inRange: function(e, t) {
                                ...
                                if (a) {
                                    for (var n = se.getAngleFromPoint(a, {
                                            x: e,
                                            y: t
                                        }), r = n.angle, i = n.distance, s = a.startAngle, o = a.endAngle; o < s;) o += ke;
                                    for (; r > o;) r -= ke;
                                    for (; r < s;) r += ke;
                                    var d = r >= s && r <= o,
                            ...
                            draw: function() {
                                ...
                                if (t.save(), t.fillStyle = a.backgroundColor, t.strokeStyle = a.borderColor, r.fullCircles) {
                                    for (r.endAngle = r.startAngle + ke, t.beginPath(), t.arc(r.x, r.y, r.outerRadius, r.startAngle, r.endAngle), t.arc(r.x, r.y, r.innerRadius, r.endAngle, r.startAngle, !0), t.closePath(), e = 0; e < r.fullCircles; ++e) t.fill();
                                    r.endAngle = r.startAngle + a.circumference % ke
                                }
                                t.beginPath(), t.arc(r.x, r.y, r.outerRadius, r.startAngle, r.endAngle), t.arc(r.x, r.y, r.innerRadius, r.endAngle, r.startAngle, !0), t.closePath(), t.fill(), a.borderWidth && xe(t, a, r), t.restore()
                            }
                        }),
                    ...
                    var We = he.extend({
                            ...
                            draw: function(e) {
                                var t = this._view,
                                    ...
                                    d = X.global,
                                    l = d.defaultColor;
                                t.skip || (void 0 === e || se.canvas._isPointInArea(t, e)) && (a.strokeStyle = t.borderColor || l, a.lineWidth = Pe(t.borderWidth, d.elements.point.borderWidth), a.fillStyle = t.backgroundColor || l, se.canvas.drawPoint(a, n, i, s, o, r))
                            }
                        }),
                    ...
                    var at = be.extend({
                            ...
                            _resolveDataElementOptions: function() {
                                var e = this,
                                    t = se.extend({}, be.prototype._resolveDataElementOptions.apply(e, arguments)),
                    ...
                    var it = be.extend({
                            ...
                            _resolveDataElementOptions: function(e, t) {
                                var a = this,
                                    ...
                                    i = e.custom || {},
                                    s = r.data[t] || {},
                                    o = be.prototype._resolveDataElementOptions.apply(a, arguments),
                                    d = {
                                        chart: n,
                                        dataIndex: t,
                                        dataset: r,
                    ...
                    var ut = be.extend({
                        ...
                        update: function(e) {
                            ...
                            if (M < dt) {
                                ...
                                l = (S - x) / 2, u = (H - T) / 2, _ = -(S + x) / 2, m = -(H + T) / 2
                            }
                    ...
                    var gt = be.extend({
                            ...
                            _resolveDatasetElementOptions: function(e) {
                                var t = this,
                                    ...
                                    r = t.chart.options,
                                    i = r.elements.line,
                                    s = be.prototype._resolveDatasetElementOptions.apply(t, arguments);
                    ...
                    var bt = be.extend({
                        ...
                        _resolveDatasetElementOptions: function() {
                            var e = this,
                                t = e._config,
                                a = e.chart.options,
                                n = be.prototype._resolveDatasetElementOptions.apply(e, arguments);
                    ...
                    var Vt = {
                            ...
                            update: function(e, t, a) {
                                if (e) {
                                    ...
                                    Wt(d.concat(l), u), Rt(d, _, u), Rt(l, _, u) && Rt(d, _, u), It(_), Bt(o.leftAndTop, _, u), _.x += _.w, _.y += _.h, Bt(o.rightAndBottom, _, u), e.chartArea = {
                                        left: _.left,
                                        top: _.top,
                                        right: _.left + _.w,
                                        bottom: _.top + _.h
                    ...
                    var Oa = he.extend({
                            ...
                            getTitle: function() {
                                var e = this,
                                    ...
                                    i = [];
                                return i = ka(i, Da(a)), i = ka(i, Da(n)), i = ka(i, Da(r))
                            },
                            getBeforeBody: function() {
                                return Pa(this._options.callbacks.beforeBody.apply(this, arguments))
                            },
                            getBody: function(e, t) {
                                ...
                                return se.each(e, (function(e) {
                                    ...
                                    ka(i.before, Da(n.beforeLabel.call(a, e, t))), ka(i.lines, n.label.call(a, e, t)), ka(i.after, Da(n.afterLabel.call(a, e, t))), r.push(i)
                                })), r
                            },
                            getAfterBody: function() {
                                return Pa(this._options.callbacks.afterBody.apply(this, arguments))
                            },
                            getFooter: function() {
                                var e = this,
                                    t = e._options.callbacks,
                            ...
                            update: function(e) {
                                ...
                                if (o.length) {
                                    ...
                                    })), s.title = n.getTitle(f, d), s.beforeBody = n.getBeforeBody(f, d), s.body = n.getBody(f, d), s.afterBody = n.getAfterBody(f, d), s.footer = n.getFooter(f, d), s.x = m.x, s.y = m.y, s.caretPadding = r.caretPadding, s.labelColors = c, s.labelTextColors = h, s.dataPoints = f, u = Ha(s, _ = Ta(this, s), l = Sa(this, _), n._chart)
                                } else s.opacity = 0;
                            ...
                            drawTitle: function(e, t, a) {
                                ...
                                if (o) {
                                    ...
                                    for (e.x = ja(t, t._titleAlign), a.textAlign = d.textAlign(t._titleAlign), a.textBaseline = "middle", n = t.titleFontSize, r = t.titleSpacing, a.fillStyle = t.titleFontColor, a.font = se.fontString(n, t._titleFontStyle, t._titleFontFamily), i = 0; i < o; ++i) a.fillText(s[i], d.x(e.x), e.y + n / 2), e.y += n + r, i + 1 === o && (e.y += t.titleMarginBottom - r)
                                }
                            },
                            drawBody: function(e, t, a) {
                                var n, r, i, s, o, d, l, u, _ = t.bodyFontSize,
                                    ...
                                    L = g.textAlign(c);
                                for (a.textAlign = c, a.textBaseline = "middle", a.font = se.fontString(_, t._bodyFontStyle, t._bodyFontFamily), e.x = ja(t, L), a.fillStyle = t.bodyFontColor, se.each(t.beforeBody, y), M = f && "right" !== L ? "center" === c ? _ / 2 + 1 : _ + 2 : 0, o = 0, l = h.length; o < l; ++o) {
                            ...
                            drawFooter: function(e, t, a) {
                                ...
                                if (s) {
                                    ...
                                    for (e.x = ja(t, t._footerAlign), e.y += t.footerMarginTop, a.textAlign = o.textAlign(t._footerAlign), a.textBaseline = "middle", n = t.footerFontSize, a.fillStyle = t.footerFontColor, a.font = se.fontString(n, t._footerFontStyle, t._footerFontFamily), r = 0; r < s; ++r) a.fillText(i[r], o.x(e.x), e.y + n / 2), e.y += n + t.footerSpacing
                                }
                            },
                    ...
                    se.extend(Va.prototype, {
                        construct: function(e, t) {
                            ...
                            var n = ga.acquireContext(e, t),
                                ...
                                i = r && r.height,
                                s = r && r.width;
                            a.id = se.uid(), a.ctx = n, a.canvas = r, a.config = t, a.width = s, a.height = i, a.aspectRatio = i ? s / i : null, a.options = t.options, a._bufferedRender = !1, a._layers = [], a.chart = a, a.controller = a, Va.instances[a.id] = a, Object.defineProperty(a, "data", {
                                get: function() {
                        ...
                        update: function(e) {
                            ...
                            if (e && "object" == typeof e || (e = {
                                ...
                                n.updateLayout(), n.options.animation && n.options.animation.duration && se.each(r, (function(e) {
                                    e.reset()
                                })), n.updateDatasets(), n.tooltip.initialize(), n.lastActive = [], ya.notify(n, "afterUpdate"), n._layers.sort(Ba("z", "_idx")), n._bufferedRender ? n._bufferedRequest = {
                                    duration: e.duration,
                                    easing: e.easing,
                                    lazy: e.lazy
                                } : n.render(e)
                        ...
                        updateLayout: function() {
                            var e = this;
                            !1 !== ya.notify(e, "beforeLayout") && (Vt.update(this, this.width, this.height), e._layers = [], se.each(e.boxes, (function(t) {
                        ...
                        getElementsAtEvent: function(e) {
                            return jt.modes.label(this, e, {
                                intersect: !0
                            })
                        },
                        getElementsAtXAxis: function(e) {
                            return jt.modes["x-axis"](this, e, {
                                intersect: !0
                            })
                        },
                        ...
                        getDatasetAtEvent: function(e) {
                            return jt.modes.dataset(this, e, {
                                intersect: !0
                            })
                        },
                        ...
                        destroy: function() {
                            ...
                            n && (a.unbindEvents(), se.canvas.clear(a), ga.releaseContext(a.ctx), a.canvas = null, a.ctx = null), ya.notify(a, "destroy"), delete Va.instances[a.id]
                        },
                    ...
                    var Ja = Va;
                    Va.Controller = Va, Va.types = {}, se.configMerge = Ea, se.scaleMerge = Ca;
                    var Ua = function() {
                        function e(e, t, a) {
                            var n;
                    ...
                    var Mn = he.extend({
                        ...
                        fit: function() {
                            ...
                            if (l ? t.width = e.maxWidth : o && (t.width = sn(s) + on(i)), l ? o && (t.height = sn(s) + on(i)) : t.height = e.maxHeight, r.display && o) {
                                ...
                                if (l) {
                                    ...
                                    var b, k, D = e.getPixelForTick(0) - e.left,
                                        w = e.right - e.getPixelForTick(e.getTicks().length - 1);
                                    g ? (b = d ? L * m.width + Y * m.offset : Y * (m.height - m.offset), k = d ? Y * (c.height - c.offset) : L * c.width + Y * c.offset) : (b = m.width / 2, k = c.width / 2), e.paddingLeft = Math.max((b - D) * e.width / (e.width - D), 0) + 3, e.paddingRight = Math.max((k - w) * e.width / (e.width - w), 0) + 3
                                } else {
                                    var x = r.mirror ? 0 : h.width + p + M;
                                    t.width = Math.min(e.maxWidth, t.width + x), e.paddingTop = m.height / 2, e.paddingBottom = c.height / 2
                                }
                            }
                        ...
                        _computeGridLineItems: function(e) {
                            ...
                            for ("top" === v ? (t = P(g.bottom), o = g.bottom - x, l = t - H, _ = P(e.top) + H, c = e.bottom) : "bottom" === v ? (t = P(g.top), _ = e.top, c = P(e.bottom) - H, o = t + H, l = g.top + x) : "left" === v ? (t = P(g.right), s = g.right - x, d = t - H, u = P(e.left) + H, m = e.right) : (t = P(g.left), u = e.left, m = P(e.right) - H, s = t + H, d = g.left + x), a = 0; a < w; ++a) n = D[a] || {}, Xa(n.label) && a < D.length || (a === g.zeroLineIndex && L.offset === b ? (h = Y.zeroLineWidth, f = Y.zeroLineColor, M = Y.zeroLineBorderDash || [], p = Y.zeroLineBorderDashOffset || 0) : (h = en(Y.lineWidth, a, 1), f = en(Y.color, a, "rgba(0,0,0,0.1)"), M = Y.borderDash || [], p = Y.borderDashOffset || 0), void 0 !== (r = an(g, n._index || a, b)) && (i = j(y, r, h), k ? s = d = u = m = i : o = l = _ = c = i, T.push({
                                tx1: s,
                                ty1: o,
                                tx2: d,
                                ty2: l,
                    ...
                    var Pn = Dn.extend({
                            determineDataLimits: function() {
                                ...
                                for (e = 0; e < u; ++e) a = s[(t = o[e]).index].data, d ? Hn(r, l, t, a) : jn(r, t, a);
                                se.each(l, (function(e) {
                                    n = e.pos.concat(e.neg), r.min = Math.min(r.min, se.min(n)), r.max = Math.max(r.max, se.max(n))
                                })), r.min = se.isFinite(r.min) && !isNaN(r.min) ? r.min : xn, r.max = se.isFinite(r.max) && !isNaN(r.max) ? r.max : Tn, r.handleTickRangeOptions()
                            },
                            _computeTickLimit: function() {
                                var e, t = this;
                    ...
                    var wr = {
                        ...
                        xr = pn.extend({
                            ...
                            buildTicks: function() {
                                ...
                                return n.min = r, n.max = i, n._unit = d.unit || (o.autoSkip ? yr(d.minUnit, n.min, n.max, _) : Lr(n, u.length, d.minUnit, n.min, n.max)), n._majorUnit = o.major.enabled && "year" !== n._unit ? Yr(n._unit) : void 0, n._table = hr(n._timestamps.data, r, i, c), n._offsets = br(n._table, u, r, i, s), o.reverse && u.reverse(), Dr(n, u, n._majorUnit)
                            },
                            getLabelForIndex: function(e, t) {
                                var a = this,
                                    n = a._adapter,
                    ...
                    function Cr(e) {
                        var t = e.fill,
                            a = "dataset";
                        return !1 === t ? null : (isFinite(t) || (a = "boundary"), jr[a](e))
                    }
                        ...
                        draw: function() {
                            ...
                            if (t.display) {
                                ...
                                var M = Jr(a, f),
                                    ...
                                    g = function(e, t, n) {
                                        if (!(isNaN(M) || M <= 0)) {
                                            ...
                                            if (m.fillStyle = Vr(n.fillStyle, r), m.lineCap = Vr(n.lineCap, i.borderCapStyle), m.lineDashOffset = Vr(n.lineDashOffset, i.borderDashOffset), m.lineJoin = Vr(n.lineJoin, i.borderJoinStyle), m.lineWidth = s, m.strokeStyle = Vr(n.strokeStyle, r), m.setLineDash && m.setLineDash(Vr(n.lineDash, i.borderDash)), a && a.usePointStyle) {
                                ...
                                se.each(e.legendItems, (function(t, n) {
                                    ...
                                    var b = _.x(c);
                                    g(b, h, t), p[n].left = _.leftForLtr(b, p[n].width), p[n].top = h, y(b, h, t, r), Y ? u.x += i + a.padding : u.y += v
                    ...
                    var qr = {
                            ...
                            beforeUpdate: function(e) {
                                var t = e.options.legend,
                                    a = e.legend;
                                t ? (se.mergeIf(t, X.global.legend), a ? (Vt.configure(e, a, t), a.options = t) : Gr(e, t)) : a && (Vt.removeBox(e, a), delete e.legend)
                            },
            ...
            6700: (e, t, a) => {
                ...
                }, r.resolve = i, e.exports = r, r.id = 6700
            },
            381: function(e, t, a) {
                (e = a.nmd(e)).exports = function() {
                    ...
                    function v(e, t) {
                        var a, n, r;
                        if (u(t._isAMomentObject) || (e._isAMomentObject = t._isAMomentObject), u(t._i) || (e._i = t._i), u(t._f) || (e._f = t._f), u(t._l) || (e._l = t._l), u(t._strict) || (e._strict = t._strict), u(t._tzm) || (e._tzm = t._tzm), u(t._isUTC) || (e._isUTC = t._isUTC), u(t._offset) || (e._offset = t._offset), u(t._pf) || (e._pf = p(t)), u(t._locale) || (e._locale = t._locale), L.length > 0)
                            for (a = 0; a < L.length; a++) u(r = t[n = L[a]]) || (e[n] = r);
                        return e
                    }
                    ...
                    function V(e, t) {
                        return e.isValid() ? (t = J(t, e.localeData()), z[t] = z[t] || B(t), z[t](e)) : e.localeData().invalidDate()
                    }
                    ...
                    })), ne("month", "M"), oe("month", 8), Fe("M", be), Fe("MM", be, ye), Fe("MMM", (function(e, t) {
                    ...
                    function dt(e, t, a) {
                        ...
                        return a ? "MMM" === t ? -1 !== (r = Be.call(this._shortMonthsParse, s)) ? r : null : -1 !== (r = Be.call(this._longMonthsParse, s)) ? r : null : "MMM" === t ? -1 !== (r = Be.call(this._shortMonthsParse, s)) || -1 !== (r = Be.call(this._longMonthsParse, s)) ? r : null : -1 !== (r = Be.call(this._longMonthsParse, s)) || -1 !== (r = Be.call(this._shortMonthsParse, s)) ? r : null
                    }
                    ...
                    })), N(0, ["YYYY", 4], 0, "year"), N(0, ["YYYYY", 5], 0, "year"), N(0, ["YYYYYY", 6, !0], 0, "year"), ne("year", "y"), oe("year", 1), Fe("Y", He), Fe("YY", be, ye), Fe("YYYY", xe, Ye), Fe("YYYYY", Te, ve), Fe("YYYYYY", Te, ve), Ie(["YYYYY", "YYYYYY"], Ve), Ie("YYYY", (function(e, t) {
                    ...
                    function bt(e, t, a) {
                        ...
                        return s < 1 ? n = s + kt(r = e.year() - 1, t, a) : s > kt(e.year(), t, a) ? (n = s - kt(e.year(), t, a), r = e.year() + 1) : (r = e.year(), n = s), {
                            week: n,
                            year: r
                        }
                    }
                    ...
                    N("w", ["ww", 2], "wo", "week"), N("W", ["WW", 2], "Wo", "isoWeek"), ne("week", "w"), ne("isoWeek", "W"), oe("week", 5), oe("isoWeek", 5), Fe("w", be), Fe("ww", be, ye), Fe("W", be), Fe("WW", be, ye), Ne(["w", "ww", "W", "WW"], (function(e, t, a, n) {
                        t[n.substr(0, 1)] = _e(e)
                    }));
                    var wt = {
                        dow: 0,
                    ...
                    })), N("e", 0, 0, "weekday"), N("E", 0, 0, "isoWeekday"), ne("day", "d"), ne("weekday", "e"), ne("isoWeekday", "E"), oe("day", 11), oe("weekday", 11), oe("isoWeekday", 11), Fe("d", be), Fe("e", be), Fe("E", be), Fe("dd", (function(e, t) {
                    ...
                    })), ea("a", !0), ea("A", !1), ne("hour", "h"), oe("hour", 13), Fe("a", ta), Fe("A", ta), Fe("H", be), Fe("h", be), Fe("k", be), Fe("HH", be, ye), Fe("hh", be, ye), Fe("kk", be, ye), Fe("hmm", ke), Fe("hmmss", De), Fe("Hmm", ke), Fe("Hmmss", De), Ie(["H", "HH"], Ge), Ie(["k", "kk"], (function(e, t, a) {
                        var n = _e(e);
                        t[Ge] = 24 === n ? 0 : n
                    ...
                    function ha(e, t) {
                        var a;
                        return e && ((a = u(t) ? pa(e) : fa(e, t)) ? sa = a : "undefined" != typeof console && console.warn && console.warn("Locale " + e + " not found. Did you forget to load it?")), sa._abbr
                    }
                        ...
                        if (null !== t) {
                            ...
                            if (t.abbr = e, null != da[e]) S("defineLocaleOverride", "use moment.updateLocale(localeName, config) to change an existing locale. moment.defineLocale(localeName, config) should only be used for creating a new locale See http://momentjs.com/guides/#/warnings/define-locale/ for more info."), n = da[e]._config;
                                ...
                                if (null != da[t.parentLocale]) n = da[t.parentLocale]._config;
                                    ...
                                    if (null == (a = ca(t.parentLocale))) return la[t.parentLocale] || (la[t.parentLocale] = []), la[t.parentLocale].push({
                                        name: e,
                                        config: t
                                    }), null;
                                    n = a._config
                                } return da[e] = new O(P(n, t)), la[e] && la[e].forEach((function(e) {
                                fa(e.name, e.config)
                            })), ha(e), da[e]
                        }
                    ...
                    function Ma(e, t) {
                        if (null != t) {
                            var a, n, r = oa;
                            null != da[e] && null != da[e].parentLocale ? da[e].set(P(da[e]._config, t)) : (null != (n = ca(e)) && (r = n._config), t = P(r, t), null == n && (t.abbr = e), (a = new O(t)).parentLocale = da[e], da[e] = a), ha(e)
                        } else null != da[e] && (null != da[e].parentLocale ? (da[e] = da[e].parentLocale, e === ha() && ha(e)) : null != da[e] && delete da[e]);
                        return da[e]
                    }
                    ...
                    function ya(e) {
                        var t, a = e._a;
                        return a && -2 === p(e).overflow && (t = a[Je] < 0 || a[Je] > 11 ? Je : a[Ue] < 1 || a[Ue] > et(a[Ve], a[Je]) ? Ue : a[Ge] < 0 || a[Ge] > 24 || 24 === a[Ge] && (0 !== a[qe] || 0 !== a[Ke] || 0 !== a[Ze]) ? Ge : a[qe] < 0 || a[qe] > 59 ? qe : a[Ke] < 0 || a[Ke] > 59 ? Ke : a[Ze] < 0 || a[Ze] > 999 ? Ze : -1, p(e)._overflowDayOfYear && (t < Ve || t > Ue) && (t = Ue), p(e)._overflowWeeks && -1 === t && (t = $e), p(e)._overflowWeekday && -1 === t && (t = Xe), p(e).overflow = t), e
                    }
                    ...
                    function Sa(e, t, a, n, r, i) {
                        var s = [Ha(e), at.indexOf(t), parseInt(a, 10), parseInt(n, 10), parseInt(r, 10)];
                    ...
                    function Aa(e) {
                        var t, a = wa.exec(ja(e._i));
                        if (a) {
                            if (t = Sa(a[4], a[3], a[2], a[5], a[6], a[7]), !Pa(a[1], t, e)) return;
                            e._a = t, e._tzm = Oa(a[8], a[9], a[10]), e._d = Lt.apply(null, e._a), e._d.setUTCMinutes(e._d.getUTCMinutes() - e._tzm), p(e).rfc2822 = !0
                        } else e._isValid = !1
                    }

                    function Fa(e) {
                        var t = Da.exec(e._i);
                        null === t ? (Ta(e), !1 === e._isValid && (delete e._isValid, Aa(e), !1 === e._isValid && (delete e._isValid, e._strict ? e._isValid = !1 : r.createFromInputFallback(e)))) : e._d = new Date(+t[1])
                    }
                    ...
                    function Ea(e) {
                        var t, a, n, r, i, s = [];
                        if (!e._d) {
                            for (n = Ca(e), e._w && null == e._a[Ue] && null == e._a[Je] && za(e), null != e._dayOfYear && (i = Wa(e._a[Ve], n[Ve]), (e._dayOfYear > Mt(i) || 0 === e._dayOfYear) && (p(e)._overflowDayOfYear = !0), a = Lt(i, 0, e._dayOfYear), e._a[Je] = a.getUTCMonth(), e._a[Ue] = a.getUTCDate()), t = 0; t < 3 && null == e._a[t]; ++t) e._a[t] = s[t] = n[t];
                    ...
                    function za(e) {
                        ...
                        null != (t = e._w).GG || null != t.W || null != t.E ? (i = 1, s = 4, a = Wa(t.GG, e._a[Ve], bt(qa(), 1, 4).year), n = Wa(t.W, 1), ((r = Wa(t.E, 1)) < 1 || r > 7) && (d = !0)) : (i = e._locale._week.dow, s = e._locale._week.doy, l = bt(qa(), i, s), a = Wa(t.gg, e._a[Ve], l.year), n = Wa(t.w, l.week), null != t.d ? ((r = t.d) < 0 || r > 6) && (d = !0) : null != t.e ? (r = t.e + i, (t.e < 0 || t.e > 6) && (d = !0)) : r = i), n < 1 || n > kt(a, i, s) ? p(e)._overflowWeeks = !0 : null != d ? p(e)._overflowWeekday = !0 : (o = vt(a, n, r, i, s), e._a[Ve] = o.year, e._dayOfYear = o.dayOfYear)
                    }
                        ...
                        if (e._f !== r.ISO_8601)
                            if (e._f !== r.RFC_2822) {
                                ...
                                var t, a, n, i, s, o, d = "" + e._i,
                                    l = d.length,
                                    u = 0;
                                for (n = J(e._f, e._locale).match(C) || [], t = 0; t < n.length; t++) i = n[t], (a = (d.match(We(i, e)) || [])[0]) && ((s = d.substr(0, d.indexOf(a))).length > 0 && p(e).unusedInput.push(s), d = d.slice(d.indexOf(a) + a.length), u += a.length), I[i] ? (a ? p(e).empty = !1 : p(e).unusedTokens.push(i), Re(i, a, e)) : e._strict && !a && p(e).unusedTokens.push(i);
                                p(e).charsLeftOver = l - u, d.length > 0 && p(e).unusedInput.push(d), e._a[Ge] <= 12 && !0 === p(e).bigHour && e._a[Ge] > 0 && (p(e).bigHour = void 0), p(e).parsedDateParts = e._a.slice(0), p(e).meridiem = e._meridiem, e._a[Ge] = Na(e._locale, e._a[Ge], e._meridiem), null !== (o = p(e).era) && (e._a[Ve] = e._locale.erasConvertYear(o, e._a[Ve])), Ea(e), ya(e)
                            } else Aa(e);
                        else Ta(e)
                    }
                    ...
                    function Ra(e) {
                        ...
                        for (r = 0; r < e._f.length; r++) i = 0, s = !1, t = v({}, e), null != e._useUTC && (t._useUTC = e._useUTC), t._f = e._f[r], Ia(t), g(t) && (s = !0), i += p(t).charsLeftOver, i += 10 * p(t).unusedTokens.length, p(t).score = i, o ? i < n && (n = i, a = t) : (null == n || i < n || s) && (n = i, a = t, s && (o = !0));
                        h(e, a || t)
                    }
                    ...
                    function Ja(e) {
                        var t = e._i,
                            a = e._f;
                        return e._locale = e._locale || pa(e._l), null === t || void 0 === a && "" === t ? y({
                            nullInput: !0
                        }) : ("string" == typeof t && (e._i = t = e._locale.preparse(t)), k(t) ? new b(ya(t)) : (m(t) ? e._d = t : s(a) ? Ra(e) : a ? Ia(e) : Ua(e), g(e) || (e._d = null), e))
                    }

                    function Ua(e) {
                        var t = e._i;
                        u(t) ? e._d = new Date(r.now()) : m(t) ? e._d = new Date(t.valueOf()) : "string" == typeof t ? Fa(e) : s(t) ? (e._a = c(t.slice(0), (function(e) {
                            return parseInt(e, 10)
                        })), Ea(e)) : o(t) ? Ba(e) : _(t) ? e._d = new Date(t) : r.createFromInputFallback(e)
                    }

                    function Ga(e, t, a, n, r) {
                        var i = {};
                        return !0 !== t && !1 !== t || (n = t, t = void 0), !0 !== a && !1 !== a || (n = a, a = void 0), (o(e) && l(e) || s(e) && 0 === e.length) && (e = void 0), i._isAMomentObject = !0, i._useUTC = i._isUTC = r, i._l = a, i._i = e, i._f = t, i._strict = n, Va(i)
                    }
                    ...
                    var Ka = w("moment().min is deprecated, use moment.max instead. http://momentjs.com/guides/#/warnings/min-max/", (function() {
                            var e = qa.apply(null, arguments);
                            return this.isValid() && e.isValid() ? e < this ? this : e : y()
                        })),
                        Za = w("moment().max is deprecated, use moment.min instead. http://momentjs.com/guides/#/warnings/min-max/", (function() {
                            var e = qa.apply(null, arguments);
                            return this.isValid() && e.isValid() ? e > this ? this : e : y()
                        }));
                    ...
                    function an(e) {
                        var t, a, n = !1;
                        for (t in e)
                            if (d(e, t) && (-1 === Be.call(tn, t) || null != e[t] && isNaN(e[t]))) return !1;
                    ...
                    function sn(e) {
                        var t = ie(e),
                            ...
                            l = t.second || 0,
                            u = t.millisecond || 0;
                        this._isValid = an(t), this._milliseconds = +u + 1e3 * l + 6e4 * d + 1e3 * o * 60 * 60, this._days = +s + 7 * i, this._months = +r + 3 * n + 12 * a, this._data = {}, this._locale = pa(), this._bubble()
                    }
                    ...
                    un("Z", ":"), un("ZZ", ""), Fe("Z", Pe), Fe("ZZ", Pe), Ie(["Z", "ZZ"], (function(e, t, a) {
                    ...
                    function mn(e, t) {
                        var a, n, r = (t || "").match(e);
                        return null === r ? null : 0 === (n = 60 * (a = ((r[r.length - 1] || []) + "").match(_n) || ["-", 0, 0])[1] + _e(a[2])) ? 0 : "+" === a[0] ? n : -n
                    }

                    function cn(e, t) {
                        var a, n;
                        return t._isUTC ? (a = t.clone(), n = (k(e) || m(e) ? e.valueOf() : qa(e).valueOf()) - a.valueOf(), a._d.setTime(a._d.valueOf() + n), r.updateOffset(a, !1), a) : qa(e).local()
                    }
                    ...
                    function fn(e, t, a) {
                        ...
                        if (null != e) {
                            ...
                            return !this._isUTC && t && (n = hn(this)), this._offset = e, this._isUTC = !0, null != n && this.add(n, "m"), i !== e && (!t || this._changeInProgress ? On(this, Tn(e - i, "m"), 1, !1) : this._changeInProgress || (this._changeInProgress = !0, r.updateOffset(this, !0), this._changeInProgress = null)), this
                        }
                    ...
                    function vn() {
                        ...
                        var e, t = {};
                        return v(t, this), (t = Ja(t))._a ? (e = t._isUTC ? f(t._a) : qa(t._a), this._isDSTShifted = this.isValid() && ln(t._a, e.toArray()) > 0) : this._isDSTShifted = !1, this._isDSTShifted
                    }
                    ...
                    function Tn(e, t) {
                        ...
                        return on(e) ? i = {
                            ...
                            d: e._days,
                            M: e._months
                        } : _(e) || !isNaN(+e) ? (i = {}, t ? i[t] = +e : i.milliseconds = +e) : (s = wn.exec(e)) ? (a = "-" === s[1] ? -1 : 1, i = {
                            y: 0,
                            d: _e(s[Ue]) * a,
                            h: _e(s[Ge]) * a,
                            m: _e(s[qe]) * a,
                            ...
                            m: Sn(s[7], a),
                            s: Sn(s[8], a)
                        }) : null == i ? i = {} : "object" == typeof i && ("from" in i || "to" in i) && (r = jn(qa(i.from), qa(i.to)), (i = {}).ms = r.milliseconds, i.M = r.months), n = new sn(i), on(e) && d(e, "_locale") && (n._locale = e._locale), on(e) && d(e, "_isValid") && (n._isValid = e._isValid), n
                    }
                    ...
                    function jn(e, t) {
                        var a;
                        return e.isValid() && t.isValid() ? (t = cn(t, e), e.isBefore(t) ? a = Hn(e, t) : ((a = Hn(t, e)).milliseconds = -a.milliseconds, a.months = -a.months), a) : {
                            milliseconds: 0,
                            months: 0
                        }
                    }
                    ...
                    function Pn(e, t) {
                        return function(a, n) {
                            var r;
                            return null === n || isNaN(+n) || (S(t, "moment()." + t + "(period, number) is deprecated. Please use moment()." + t + "(number, period). See http://momentjs.com/guides/#/warnings/add-inverted-param/ for more info."), r = a, a = n, n = r), On(this, Tn(a, n), e), this
                        }
                    }
                    ...
                    function Rn(e, t) {
                        1 === arguments.length && (arguments[0] ? Cn(arguments[0]) ? (e = arguments[0], t = void 0) : In(arguments[0]) && (t = arguments[0], e = void 0) : (e = void 0, t = void 0));
                        var a = e || qa(),
                    ...
                    function Qn(e) {
                        ...
                        return a.year() < 0 || a.year() > 9999 ? V(a, t ? "YYYYYY-MM-DD[T]HH:mm:ss.SSS[Z]" : "YYYYYY-MM-DD[T]HH:mm:ss.SSSZ") : H(Date.prototype.toISOString) ? t ? this.toDate().toISOString() : new Date(this.valueOf() + 60 * this.utcOffset() * 1e3).toISOString().replace("Z", V(a, "Z")) : V(a, t ? "YYYY-MM-DD[T]HH:mm:ss.SSS[Z]" : "YYYY-MM-DD[T]HH:mm:ss.SSSZ")
                    }
                    ...
                    function ar(e, t) {
                        return this.isValid() && (k(e) && e.isValid() || qa(e).isValid()) ? Tn({
                            to: this,
                            from: e
                    ...
                    function sr(e) {
                        var t;
                        return void 0 === e ? this._locale._abbr : (null != (t = pa(e)) && (this._locale = t), this)
                    }
                    r.defaultFormat = "YYYY-MM-DDTHH:mm:ssZ", r.defaultFormatUtc = "YYYY-MM-DDTHH:mm:ss[Z]";
                    var or = w("moment().lang() is deprecated. Instead, use moment().localeData() to get the language configuration. Use moment().locale() to change languages.", (function(e) {
                    ...
                    function Mr(e) {
                        ...
                        switch (a = this._isUTC ? fr : hr, e) {
                            ...
                            case "date":
                                ...
                                break;
                            case "hour":
                                t = this._d.valueOf(), t -= cr(t + (this._isUTC ? 0 : this.utcOffset() * ur), _r);
                                break;
                            case "minute":
                    ...
                    function pr(e) {
                        ...
                        switch (a = this._isUTC ? fr : hr, e) {
                            ...
                            case "date":
                                ...
                                break;
                            case "hour":
                                t = this._d.valueOf(), t += _r - cr(t + (this._isUTC ? 0 : this.utcOffset() * ur), _r) - 1;
                                break;
                            case "minute":
                    ...
                    function Tr(e, t) {
                        var a, n, i, s = this._eras || pa("en")._eras;
                    ...
                    function Fr(e) {
                        return d(this, "_erasNameRegex") || Rr.call(this), e ? this._erasNameRegex : this._erasRegex
                    }

                    function Wr(e) {
                        return d(this, "_erasAbbrRegex") || Rr.call(this), e ? this._erasAbbrRegex : this._erasRegex
                    }

                    function Cr(e) {
                        return d(this, "_erasNarrowRegex") || Rr.call(this), e ? this._erasNarrowRegex : this._erasRegex
                    }
                    ...
                    function Zr(e, t, a, n, r) {
                        var i;
                        return null == e ? bt(this, n, r).year : (t > (i = kt(e, n, r)) && (t = i), $r.call(this, e, t, a, n, r))
                    }
                    ...
                    N("N", 0, 0, "eraAbbr"), N("NN", 0, 0, "eraAbbr"), N("NNN", 0, 0, "eraAbbr"), N("NNNN", 0, 0, "eraName"), N("NNNNN", 0, 0, "eraNarrow"), N("y", ["y", 1], "yo", "eraYear"), N("y", ["yy", 2], 0, "eraYear"), N("y", ["yyy", 3], 0, "eraYear"), N("y", ["yyyy", 4], 0, "eraYear"), Fe("N", Er), Fe("NN", Er), Fe("NNN", Er), Fe("NNNN", zr), Fe("NNNNN", Ir), Ie(["N", "NN", "NNN", "NNNN", "NNNNN"], (function(e, t, a, n) {
                        var r = a._locale.erasParse(e, n, a._strict);
                        r ? p(a).era = r : p(a).invalidEra = e
                    })), Fe("y", Se), Fe("yy", Se), Fe("yyy", Se), Fe("yyyy", Se), Fe("yo", Nr), Ie(["y", "yy", "yyy", "yyyy"], Ve), Ie(["yo"], (function(e, t, a, n) {
                        var r;
                        a._locale._eraYearOrdinalRegex && (r = e.match(a._locale._eraYearOrdinalRegex)), a._locale.eraYearOrdinalParse ? t[Ve] = a._locale.eraYearOrdinalParse(e, r) : t[Ve] = parseInt(e, 10)
                    })), N(0, ["gg", 2], 0, (function() {
                        return this.weekYear() % 100
                    })), N(0, ["GG", 2], 0, (function() {
                        return this.isoWeekYear() % 100
                    })), Br("gggg", "weekYear"), Br("ggggg", "weekYear"), Br("GGGG", "isoWeekYear"), Br("GGGGG", "isoWeekYear"), ne("weekYear", "gg"), ne("isoWeekYear", "GG"), oe("weekYear", 1), oe("isoWeekYear", 1), Fe("G", He), Fe("g", He), Fe("GG", be, ye), Fe("gg", be, ye), Fe("GGGG", xe, Ye), Fe("gggg", xe, Ye), Fe("GGGGG", Te, ve), Fe("ggggg", Te, ve), Ne(["gggg", "ggggg", "GGGG", "GGGGG"], (function(e, t, a, n) {
                        t[n.substr(0, 2)] = _e(e)
                    })), Ne(["gg", "GG"], (function(e, t, a, n) {
                        t[n] = r.parseTwoDigitYear(e)
                    })), N("Q", 0, "Qo", "quarter"), ne("quarter", "Q"), oe("quarter", 7), Fe("Q", ge), Ie("Q", (function(e, t) {
                        t[Je] = 3 * (_e(e) - 1)
                    })), N("D", ["DD", 2], "Do", "date"), ne("date", "D"), oe("date", 9), Fe("D", be), Fe("DD", be, ye), Fe("Do", (function(e, t) {
                    ...
                    N("DDD", ["DDDD", 3], "DDDo", "dayOfYear"), ne("dayOfYear", "DDD"), oe("dayOfYear", 4), Fe("DDD", we), Fe("DDDD", Le), Ie(["DDD", "DDDD"], (function(e, t, a) {
                        a._dayOfYear = _e(e)
                    })), N("m", ["mm", 2], 0, "minute"), ne("minute", "m"), oe("minute", 14), Fe("m", be), Fe("mm", be, ye), Ie(["m", "mm"], qe);
                    var ti = me("Minutes", !1);
                    N("s", ["ss", 2], 0, "second"), ne("second", "s"), oe("second", 15), Fe("s", be), Fe("ss", be, ye), Ie(["s", "ss"], Ke);
                    var ai, ni, ri = me("Seconds", !1);
                    for (N("S", 0, 0, (function() {
                        ...
                        })), ne("millisecond", "ms"), oe("millisecond", 16), Fe("S", we, ge), Fe("SS", we, ye), Fe("SSS", we, Le), ai = "SSSS"; ai.length <= 9; ai += "S") Fe(ai, Se);
                    ...
                    ni = me("Milliseconds", !1), N("z", 0, 0, "zoneAbbr"), N("zz", 0, 0, "zoneName");
                    var di = b.prototype;
                    ...
                    function hi(e, t, a) {
                        if (_(e) && (t = e, e = void 0), e = e || "", null != t) return ci(e, t, a, "month");
                        var n, r = [];
                    ...
                    mi.calendar = F, mi.longDateFormat = G, mi.invalidDate = K, mi.ordinal = X, mi.preparse = _i, mi.postformat = _i, mi.relativeTime = ee, mi.pastFuture = te, mi.set = j, mi.eras = Tr, mi.erasParse = Sr, mi.erasConvertYear = Hr, mi.erasAbbrRegex = Wr, mi.erasNameRegex = Fr, mi.erasNarrowRegex = Cr, mi.months = st, mi.monthsShort = ot, mi.monthsParse = lt, mi.monthsRegex = ht, mi.monthsShortRegex = ct, mi.week = Dt, mi.firstDayOfYear = Tt, mi.firstDayOfWeek = xt, mi.weekdays = It, mi.weekdaysMin = Rt, mi.weekdaysShort = Nt, mi.weekdaysParse = Vt, mi.weekdaysRegex = qt, mi.weekdaysShortRegex = Kt, mi.weekdaysMinRegex = Zt, mi.isPM = aa, mi.meridiem = ia, ha("en", {
                        eras: [{
                            since: "0001-01-01",
                            until: 1 / 0,
                            offset: 1,
                    ...
                    }), r.lang = w("moment.lang is deprecated. Use moment.locale instead.", ha), r.langData = w("moment.langData is deprecated. Use moment.localeData instead.", pa);
                    var Yi = Math.abs;
                    ...
                    function xi() {
                        var e, t, a, n, r, i = this._milliseconds,
                            ...
                            o = this._months,
                            d = this._data;
                        return i >= 0 && s >= 0 && o >= 0 || i <= 0 && s <= 0 && o <= 0 || (i += 864e5 * wi(Si(o) + s), s = 0, o = 0), d.milliseconds = i % 1e3, e = ue(i / 1e3), d.seconds = e % 60, t = ue(e / 60), d.minutes = t % 60, a = ue(t / 60), d.hours = a % 24, s += ue(a / 24), o += r = ue(Ti(s)), s -= wi(Si(r)), n = ue(o / 12), o %= 12, d.days = s, d.months = o, d.years = n, this
                    }
                    ...
                    function Hi(e) {
                        ...
                        if ("month" === (e = re(e)) || "quarter" === e || "year" === e) switch (t = this._days + n / 864e5, a = this._months + Ti(t), e) {
                            case "month":
                                return a;
                            case "quarter":
                                return a / 3;
                            case "year":
                                return a / 12
                        } else switch (t = this._days + Math.round(Si(this._months)), e) {
                            case "week":
                                return t / 7 + n / 6048e5;
                            case "day":
                                return t + n / 864e5;
                    ...
                    function as(e, t, a, n) {
                        ...
                        return null != a.w && (m = m || u <= 1 && ["w"] || u < a.w && ["ww", u]), (m = m || l <= 1 && ["M"] || l < a.M && ["MM", l] || _ <= 1 && ["y"] || ["yy", _])[2] = t, m[3] = +e > 0, m[4] = n, ts.apply(null, m)
                    }
                    ...
                    function is(e, t) {
                        ...
                        var a, n, r = !1,
                            i = es;
                        return "object" == typeof e && (t = e, e = !1), "boolean" == typeof e && (r = e), "object" == typeof t && (i = Object.assign({}, es, t), null != t.s && null == t.ss && (i.ss = t.s - 1)), n = as(this, !r, i, a = this.localeData()), r && (n = a.pastFuture(+this, n)), a.postformat(n)
                    }
                    var ss = Math.abs;
                    ...
                    function ds() {
                        if (!this.isValid()) return this.localeData().invalidDate();
                        var e, t, a, n, r, i, s, o, d = ss(this._milliseconds) / 1e3,
                            l = ss(this._days),
                            u = ss(this._months),
                            _ = this.asSeconds();
                        return _ ? (e = ue(d / 60), t = ue(e / 60), d %= 60, e %= 60, a = ue(u / 12), u %= 12, n = d ? d.toFixed(3).replace(/\.?0+$/, "") : "", r = _ < 0 ? "-" : "", i = os(this._months) !== os(_) ? "-" : "", s = os(this._days) !== os(_) ? "-" : "", o = os(this._milliseconds) !== os(_) ? "-" : "", r + "P" + (a ? i + a + "Y" : "") + (u ? i + u + "M" : "") + (l ? s + l + "D" : "") + (t || e || d ? "T" : "") + (t ? o + t + "H" : "") + (e ? o + e + "M" : "") + (d ? o + n + "S" : "")) : "P0D"
                    }
                    var ls = sn.prototype;
                    return ls.isValid = nn, ls.abs = vi, ls.add = ki, ls.subtract = Di, ls.as = Hi, ls.asMilliseconds = Oi, ls.asSeconds = Ai, ls.asMinutes = Fi, ls.asHours = Wi, ls.asDays = Ci, ls.asWeeks = Ei, ls.asMonths = zi, ls.asQuarters = Ii, ls.asYears = Ni, ls.valueOf = ji, ls._bubble = xi, ls.clone = Ri, ls.get = Bi, ls.milliseconds = Ji, ls.seconds = Ui, ls.minutes = Gi, ls.hours = qi, ls.days = Ki, ls.weeks = Xi, ls.months = Zi, ls.years = $i, ls.humanize = is, ls.toISOString = ds, ls.toString = ds, ls.toJSON = ds, ls.locale = sr, ls.localeData = dr, ls.toIsoString = w("toIsoString() is deprecated. Please use toISOString() instead (notice the capitals)", ds), ls.lang = or, N("X", 0, 0, "unix"), N("x", 0, 0, "valueOf"), Fe("x", He), Fe("X", Oe), Ie("X", (function(e, t, a) {
                        a._d = new Date(1e3 * parseFloat(e))
                    })), Ie("x", (function(e, t, a) {
                        a._d = new Date(_e(e))
                    })), r.version = "2.29.1", i(qa), r.fn = di, r.min = Xa, r.max = Qa, r.now = en, r.utc = f, r.unix = li, r.months = Mi, r.isDate = m, r.locale = ha, r.invalid = y, r.duration = Tn, r.isMoment = k, r.weekdays = gi, r.parseZone = ui, r.localeData = pa, r.isDuration = on, r.monthsShort = pi, r.weekdaysMin = Li, r.defineLocale = fa, r.updateLocale = Ma, r.locales = ga, r.weekdaysShort = yi, r.normalizeUnits = re, r.relativeTimeRounding = ns, r.relativeTimeThreshold = rs, r.calendarFormat = Nn, r.prototype = di, r.HTML5_FMT = {
    ...
    a.n = e => {
        ...
        d.addColorStop(0, "rgba(50, 69, 209,1)"), d.addColorStop(1, "rgba(265, 177, 249,0)");
        var l = o.createLinearGradient(0, 0, 0, 400);
        l.addColorStop(0, "rgba(255, 91, 92,1)"), l.addColorStop(1, "rgba(265, 177, 249,0)");
        new(t())(o, {
            type: "line",
            data: {
